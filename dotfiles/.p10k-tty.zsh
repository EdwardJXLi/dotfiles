# Generated by Powerlevel10k configuration wizard on 2024-06-01 at 05:55 PDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 16269.
# Wizard options: ascii, lean_8colors, 12h time, 1 line, compact, concise,
...
() {
  ...
  # Override with the P10K_CONTEXT_COLOR_TTY env var; falls back to 002.
  # Note: a Linux TTY only supports the basic 0-15 colors.
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=${P10K_CONTEXT_COLOR_TTY:-002}
